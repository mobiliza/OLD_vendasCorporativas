...
player.define('jqueryChanges',[
	...
	jQuery.fn.contentEditabel = function(options) {
		console.log('[jqueryChanges]contentEditabel [var]options: ', options);
		var $el = this,
			el = $el[0],
			defaults = {
				maxChars: 20,
		...
		function checkChars(e) {
			var code = e.keyCode,
				numberOfChars = $el.text().trim().length,
				maxChars = options.maxChars,
				stopImmediate = $.inArray(e.keyCode, options.charsStopImmediate) === -1 ? false : true,
				alwaysAllowed = $.inArray(e.keyCode, options.charsAlwaysAllowed) === -1 ? false : true,
				notAllowed = $.inArray(e.keyCode, options.charsNotAllowed) === -1 ? false : true;

			console.log('[jqueryChanges]contentEditabel [var]code, numberOfChars, maxChars, stopImmediate, alwaysAllowed, notAllowed: ', code, numberOfChars, maxChars, stopImmediate, alwaysAllowed, notAllowed);

			if(stopImmediate){
				console.log('[jqueryChanges]contentEditabel STOP IMMIDIATE');
				e.stopPropagation();
				e.stopImmediatePropagation();
			}

			if (options.enterLeave && code === 13) {
				console.log('[jqueryChanges]contentEditabel OFF');
				editableOff(e, true);
			} else if ((maxChars && numberOfChars > maxChars) || notAllowed) {
				console.log('[jqueryChanges]contentEditabel INIT BLOCKED');
				if(!alwaysAllowed){
					console.log('[jqueryChanges]contentEditabel BLOCKED');
					e.preventDefault();
				}								
			}			
		}
...
player.define("json!resources/multimedia/config.json", function(){ return {
	"defaults": {
		"template": "multimedia",
		"src": "",
		"styleObj": {
...
player.define('resources/texto/editor',[], function() {
    ...
    "resources": {
        ...
        "insert": [
            ...
            },
            {
                ...
                "content": "Capas s\u00e3o Slides Especiais que Trazem o T\u00edtulo da Sec\u00e7\u00e3o de Conte\u00fado.",
                "styleObj": {
                    "position": "relative",
                    "width": "inherit",
                    "top": "0px",
...
player.define("json!../../../../_baseClient/_base/js/desktop/slides/slideSubCapa/config.json", function(){ return {
	"resources": {
		...
		"insert": [{
			...
			"content": "Subcapas são Slides Especiais que Trazem um Subtítulo da Secção de Conteúdo.",
			"styleObj": {
				"position": "relative",
				"width": "inherit",
				"top": "0px",
...
player.define("json!../../../../_baseClient/_base/js/desktop/slides/standard/pv1-2/temp01/config.json", function(){ return {
    "defaults": {
        "name": "Slide 01 - Imagem + Destaque"
    },
    "resources": {
        "insert": [
            {
                ...
                "baseImg": "http://mobiliza-test.s3-us-west-2.amazonaws.com/clients/mobiliza/assets/own/1429114407383_nenhuma_imagem_adicionada.png",
                "src": "http://s3-us-west-2.amazonaws.com/mobiliza-test/clients/mobiliza/courses/5527fb8fdb32b7fb2e000108/snp/5527fc4edb32b7fb2e000109/5528141cdb32b7fb2e000121/r5528141cdb32b7fb2e000122/5528141cdb32b7fb2e000122_src?update=1429114428121",
                "imgHeight": 292,
                "legend": {
                    "active": false,
                    "content": "<span class=\"legendText\">Insira uma legenda para a imagem ou retire a legenda.</span>"
                },
                "border": false                
            },
            {
            ...
            },
            {
                ...
                "content": "<div style=\"text-align: left;\"><span style=\"background-color: initial;\">Insira aqui o seu T\u00edtulo</span></div>",
                "normal": {
                    "subType": "comFundo",
                    "active": false
                },
...
player.define("json!../../../../_baseClient/_base/js/desktop/slides/standard/pv1-2/temp02/config.json", function(){ return {
    "defaults": {
        "name": "Slide 02 - Imagem 3 colunas"
    },
    "resources": {
        "insert": [
            {
                ...
                "content": "Ajuste o tamanho da sua imagem de acordo com o tamanho das caixas de texto.<div>Distribua o texto igualmente entre as colunas para que estas fiquem com um tamanho semelhante, garantindo uma continuidade na leitura do texto.</div>",
                "normal": {
                    "subType": "semFundo",
                    "active": true
                },
            ...
            },
            {
                ...
                "content": "Aqui voc\u00ea pode dar continuidade ao seu conte\u00fado. Ou se desejar, inserir outro recurso dispon\u00edvel no menu a baixo.",
                "normal": {
                    "subType": "semFundo",
                    "active": true
                },
            ...
            },
            {
                ...
                "content": "Insira aqui um destaque ou exclua esse recurso",
                "normal": {
                    "subType": "comFundo",
                    "active": false
                },
            ...
            },
            {
                ...
                "content": "Aqui voc\u00ea insere o texto desejado. Esse template \u00e9 mais indicado para telas que possuam um conte\u00fado textual mais extenso. Podendo possuir um recurso lista ou n\u00e3o. A lista poder\u00e1 ser inclu\u00edda ou alter\u00e1-la na barra de menu acima.",
                "normal": {
                    "subType": "semFundo",
                    "active": true
                },
            ...
            },
            {
                ...
                "baseImg": "http://mobiliza-test.s3-us-west-2.amazonaws.com/clients/mobiliza/assets/own/1429114536203_nenhuma_imagem_adicionada_muito pequena.png",
                "src": "http://s3-us-west-2.amazonaws.com/mobiliza-test/clients/mobiliza/courses/5527fb8fdb32b7fb2e000108/snp/5527fc4edb32b7fb2e000109/552d7dfb85e5ec2b0d0001b2/r552d7dfb85e5ec2b0d0001b8/552d7dfb85e5ec2b0d0001b8_src?update=1429114714282",
                "imgHeight": 161,
                "legend": {
                    "content": "<span class=\"legendText\">Insira uma legenda para a imagem ou retire a legenda.</span>",
                    "active": false
            ...
            },
            {
                ...
                "content": "<div style=\"text-align: left;\">Insira aqui o seu T\u00edtulo<br></div>",
                "normal": {
                    "subType": "comFundo",
                    "active": false
                },
...
player.define("json!../../../../_baseClient/_base/js/desktop/slides/standard/pv1-2/temp03/config.json", function(){ return {
    "defaults": {
        "name": "Slide 03 - Imagem 3 colunas v2"
    },
    "resources": {
        "insert": [
            {
...
player.define("json!../../../../_baseClient/_base/js/desktop/slides/standard/pv1-2/temp04/config.json", function(){ return {
    "defaults": {
        "name": "Slide 04 - V\u00eddeo"
    },
    "resources": {
        "insert": [
            ...
            },
            {
                ...
                "content": "Aqui voc\u00ea insere o texto desejado. Esse template \u00e9 mais indicado para telas que possuam um conte\u00fado textual de pequeno a mediano.&nbsp;<div><br></div><div>Voc\u00ea poder\u00e1 inserir uma lista e alter\u00e1-la na barra de menu acima. Ou se desejar, insira outro recurso dispon\u00edvel no menu a baixo.\nAjuste o tamanho da caixa de texto e dos demais recursos utilizados na tela, para que ocupem juntos um \u00e1rea regular.&nbsp;</div>",
                "normal": {
                    "subType": "semFundo",
                    "active": true
                },
...
player.define("json!../../../../_baseClient/_base/js/desktop/slides/standard/pv1-2/temp05/config.json", function(){ return {
    "defaults": {
        "name": "Slide 05 - Gaveta"
    },
    "resources": {
        "insert": [
            {
            ...
            },
            {
                ...
                "content": "Aqui voc\u00ea pode dar continuidade ao seu conte\u00fado. Distribua o texto igualmente entre as colunas para que estas fiquem com um tamanho semelhante entre si, e comparadas a gaveta.",
                "normal": {
                    "subType": "semFundo",
                    "active": true
                },
            ...
            },
            {
                ...
                "content": "Aqui voc\u00ea insere o texto desejado. Se o texto for grande, voc\u00ea pode colocar o suficiente para chegar ao final desta coluna e dar continuidade nas seguintes.&nbsp;",
                "normal": {
                    "subType": "semFundo",
                    "active": true
                },
...
player.define("json!../../../../_baseClient/_base/js/desktop/slides/standard/pv1-2/temp06/config.json", function(){ return {
    "defaults": {
        "name": "Slide 06 - Atividade 01 + Imagem"
    },
    "resources": {
        "insert": [
            {
                ...
                "content": "Voc\u00ea poder\u00e1 adicionar uma pequena introdu\u00e7\u00e3o para a atividade.",
                "normal": {
                    "subType": "semFundo",
                    "active": true
                },
            ...
            },
            {
                ...
                "baseImg": "http://mobiliza-test.s3-us-west-2.amazonaws.com/clients/mobiliza/assets/own/1429114407383_nenhuma_imagem_adicionada.png",
                "src": "http://s3-us-west-2.amazonaws.com/mobiliza-test/clients/mobiliza/courses/5527fb8fdb32b7fb2e000108/snp/5527fc4edb32b7fb2e000109/552d6dcd85e5ec2b0d000194/r552d6e1e85e5ec2b0d000199/552d6e1e85e5ec2b0d000199_src?update=1429115012182",
                "imgHeight": 285,
                "legend": {
                    "content": "Teste : Teste images",
                    "active": false
            ...
            },
            {
                ...
                "content": "<div style=\"text-align: left;\"><span style=\"background-color: initial;\">Insira um t\u00edtulo para a atividade&nbsp;</span></div>",
                "normal": {
                    "subType": "comFundo",
                    "active": false
                },
...
player.define("json!../../../../_baseClient/_base/js/desktop/slides/standard/pv1-2/temp07/config.json", function(){ return {
    "defaults": {
        "name": "Slide 07 - Atividade 02 + Destaque"
    },
    "resources": {
        "insert": [
            {
            ...
            },
            {
                ...
                "content": "Aqui voc\u00ea insere o texto desejado, introduzindo a atividade ao lado. Caso haja a necessidade altere o tipo de atividade.<div><br></div><div>Lorem ipsum dolor sit amet, vim ferri corpora omittantur id. Nam ut ignota discere platonem. Ad his melius persecuti, at dicant causae vim. Eu nec novum conceptam intellegam, elitr mollis abhorreant mei ut. &nbsp;<br></div>",
                "normal": {
                    "subType": "semFundo",
                    "active": true
                },
...
player.define("json!../../../../_baseClient/_base/js/desktop/slides/standard/pv1-2/temp08/config.json", function(){ return {
    "defaults": {
        "name": "Slide 08 - Personagem 01"
    },
    "resources": {
        "insert": [
            {
                ...
                "type": "informacao",
                "title": "Dica!",
                "content": "Organize os elementos da tela e ajuste tamb\u00e9m o tamanho da sua caixa de texto.&nbsp;"
            },
            {
                "template": "texto",
                "order": 2,
            ...
            },
            {
                ...
                "src": "http://s3-us-west-2.amazonaws.com/mobiliza-test/clients/mobiliza/courses/5527fb8fdb32b7fb2e000108/snp/5527fc4edb32b7fb2e000109/55301f149cbabed41f000152/r55301f149cbabed41f000156/55301f149cbabed41f000156?update=1429282592215"
            },
            {
                "template": "texto",
                "order": 0,
...
player.define("json!../../../../_baseClient/_base/js/desktop/slides/standard/pv1-2/temp09/config.json", function(){ return {
    "defaults": {
        "name": "Slide 09 - Personagem 02"
    },
    "resources": {
        "insert": [
            {
            ...
            },
            {
                ...
                "styleObj": {
                    ...
                    "top": "124px",
                    "position": "absolute",
                    "width": "120.85913853317811px"
                },
                "src": "http://s3-us-west-2.amazonaws.com/mobiliza-test/clients/mobiliza/courses/5527fb8fdb32b7fb2e000108/snp/5527fc4edb32b7fb2e000109/553020f89cbabed41f000157/r553020f89cbabed41f00015a/553020f89cbabed41f00015a?update=1429217537548"
            },
            {
                "template": "texto",
                "order": 0,
...
player.define("json!../../../../_baseClient/_base/js/desktop/slides/standard/pv1-2/temp10/config.json", function(){ return {
    "defaults": {
        "name": "Slide 10 - Modal 01"
    },
    "resources": {
        "insert": [
            {
                ...
                "baseImg": "http://mobiliza-test.s3-us-west-2.amazonaws.com/clients/mobiliza/assets/own/1429114407383_nenhuma_imagem_adicionada.png",
                "src": "http://s3-us-west-2.amazonaws.com/mobiliza-test/clients/mobiliza/courses/5527fb8fdb32b7fb2e000108/snp/5527fc4edb32b7fb2e000109/5528261edb32b7fb2e000137/r5528261edb32b7fb2e000139/5528261edb32b7fb2e000139_src?update=1429114816554",
                "imgHeight": 307,
                "legend": {
                    "content": "<span class=\"legendText\">Insira uma legenda para a imagem ou retire a legenda.</span>",
                    "active": true
            ...
            },
            {
                ...
                "content": "Aqui voc\u00ea insere o texto desejado. Ajuste o tamanho da sua imagem de acordo com o tamanho dos demais recursos utilizados.",
                "normal": {
                    "subType": "semFundo",
                    "active": true
                },
            ...
            },
            {
                ...
                "content": "<div style=\"text-align: left;\"><span style=\"background-color: initial;\">Aqui voc\u00ea pode inserir um t\u00edtulo</span></div>",
                "normal": {
                    "subType": "comFundo",
                    "active": false
                },
...
player.define("json!../../../../_baseClient/_base/js/desktop/slides/standard/pv1-2/temp11/config.json", function(){ return {
    "defaults": {
        "name": "Slide 11 - Modal 02"
    },
    "resources": {
        "insert": [
            {
            ...
            },
            {
                ...
                "type": "importante",
                "title": "Aten\u00e7\u00e3o",
                "content": "Lorem ipsum Ut exercitation deserunt velit fugiat elit quis nostrud id irure ullamco Excepteur sint sit es."
            },
            {
                "template": "texto",
                "order": 1,
                ...
                "content": "Aqui voc\u00ea insere o texto desejado. Ajuste o tamanho da sua imagem de acordo com o tamanho dos demais recursos utilizados.&nbsp;<span style=\"line-height: 17px; font-family: OpenSansRegular, sans-serif; font-size: 14px; text-align: left; word-spacing: 5px; color: rgb(51, 51, 51); display: inline !important; float: none; background-color: initial;\">Utilize os bot\u00f5es do recurso \"Primeiro Plano\" para indicar pontos de interesse na imagem.</span><div><div><br></div><div>Edite o conte\u00fado de cada um dos bot\u00f5es clicando duas vezes sobre os mesmos.</div></div>",
                "normal": {
                    "subType": "semFundo",
                    "active": true
                },
			...
			var me = this,
				...
				snapData = {
					...
					callback: function(data) {
						...
						model.set('src', src + "?update=" + new Date().getTime());
					}
				};
...
player.define("json!../../../../_baseClient/_base/js/desktop/resources/caixaDestaque/config.json", function(){ return {
	"defaults": {
		...
		"type": "atencao",
		"title": "Atenção",
		"contentPrograme": "Esta aula terá duração de: ",
		"content": "Lorem ipsum Ut exercitation deserunt velit fugiat elit quis nostrud id irure ullamco Excepteur sint sit est consequat exercitation sit.",
		"styleObj": {
			"position": "absolute",
			"width": "283px",
		...
		*/
		...
		showing: function() {
			...
			*/
			this.recView.addElements.call(this.recView, {
				'title': '#cdTitle',
				'content': '#cdContent',
				'contentPrograme': '#cdContentPrograme'
			});

			this.recView.addEvents.call(this.recView, {
				'click _title': me.editTitle,
				'click _content': me.editContent,
				'click _contentPrograme': me.editContentPrograme
			});
		},
		...
		hiding: function() {
			...
			var me = this,
				...
				$content = me.recView.elems.$content;
				$contentPrograme = me.recView.elems.$contentPrograme;
		...
		editContentPrograme: function() {
			console.log('editContent ------- ');

			var me = this.edition, //Eventos atrelados a view do recurso tem que voltar a ter a referencia a view da edição
				//Pametros necessários para que o metodo de textEdition funcione
				params = {
					$el: me.recView.elems.$contentPrograme,
					attr: 'contentPrograme',
					textEditor: {
						options: [
							'bold',
							'italic',
...
player.define('../../../../_baseClient/_base/js/desktop/resources/imagem/editor',[], function() {
	...
	var View = {
		...
		Metodos disparados:
			- initializating: Ao final do initialiaze da view
			- showing: Ao final das funções de exibição do painel de edição
			- hiding: Ao final das funções de escondimento do painel de edição
			- positioning: Ao final das funções de posicionamento
		*/
...
player.define('text!../../../../_baseClient/_base/js/desktop/resources/botaoPP/template.html',[],function () { return '<div id="{{_id}}" class="{{class}} {{#type}}{{type}}{{/type}}" style="{{style}}">\n\t<div class="plus"></div>\n\t<div class="btnPPLeft">\t\n\t\t<div class="iconP3 iconP3-modal"></div>\n\t</div>\n\t<div class="btnPPRight"> \n\t\t<div class="tagP">{{&label}}</span>\n\t</div>\n</div>\n';});
		...
		*/
		...
		initializating: function(e) {
			...
			this.addElements({
				...
				'lockPlayerBtn': '#editionLockPlayer',
				'editionSortOptions': '#editionSortOptions'
			});
			...
			this.events = _.extend(this.events, {
				...
				'click _lockPlayerBtn': 'toggleLockPlayer',
				'click _editionSortOptions': 'toggleSortOptions'
			});
		...
		toggleSortOptions: function() {
			var me = this,
				model = me.recView.model,
				sort_options = model.get('sortOptions');

			me.sortOptions(!sort_options);
		},

		sortOptions: function(sort_options) {
			var me = this,
				model = me.recView.model,
				$editionSortOptions = me.elems.$editionSortOptions;

			if (sort_options !== true && sort_options !== false) {
				sort_options = !model.get('sortOptions');
			}
			...
			$editionSortOptions.toggleClass('selected', sort_options);
		...
		showing: function() {
			...
			me.lockPlayer(!!model.get('lock'));
			me.sortOptions(!!model.get('sortOptions'));
	...
	var View = {
		...
		*/
		...
		showing: function() {
			...
			me.$tabsNav.sortable('option', 'disabled', false);
		},
		...
		hiding: function() {
			...
			me.$tabsNav.sortable('option', 'disabled', true);
		},
		...
		editContent: function(e) {
			var me = this.edition,
				...
				params = {
					...
					maxChars: 20, //maximo de caracteres
					enterLeave: true,
					charsStopImmediate: [37, 38, 39, 40, 32, 35, 36],
					textEditor: {
						options: [ //opções do editor de texto
							'bold',
							'italic',
		...
		showBtns: function() {
			...
			me.$tabsNav = $rec.find('.ui-tabs-nav');
		...
		openTab: function(tab_index) {
			...
			function createSlideForResource(resource_id) {
				me.createSlide(resource_id, function(new_slide) {
			...
			if (!slide_id) { // slide was not created yet
				...
				if (!resource_id) {
					// resource id not available yet
					model.on('saveComplete', function() {
						createSlideForResource(model.get('_id'));
					});
				} else {
					createSlideForResource(resource_id);
				}
				return;
			}
...
player.define('../../../../_baseClient/_base/js/desktop/resources/botaoRD/editor',[], function() {
	...
	var View = {
		...
		*/
		...
		initializating: function(e) {
			...
			this.addElements({
				'content': '.tagP',
				'filePicker': '#recFilePicker',
				'redirectLinkBtn': '#editionRedirectLink',
				'inputRedirectLink': '.mbInputRedirectLink',
				'selectSlide': '#selectSlide',
				'ok': '#editionLinkOk'
			});

			this.events = _.extend(this.events, {
				'click _filePicker': 'fileManager',
				'click _redirectLinkBtn': 'addRedirectLink',
				'click _ok': 'setRedirectLink'
			});
		...
		addRedirectLink: function() {
			var me = this,
				$inputRedirectLink = this.elems.$inputRedirectLink,
				$redirectLinkBtn = this.elems.$redirectLinkBtn,
				$selectSlide = this.elems.$selectSlide,
				slides = {};

				//evita concatenação dos slides já existentes, corrigir logica
				$selectSlide
				    .find('option')
				    .remove();

				$.each(Editor.Collections.slides.models, function(i, model) {
			...
			$redirectLinkBtn.toggleClass('actived');
		},
		...
		setRedirectLink: function() {
			var me = this,
				model = me.recView.model,
				$selectSlide = this.elems.$selectSlide,
				slideID = $selectSlide.val(),
				slideText = $selectSlide.find("option:selected").text();
		...
		fileManager: function(index) {
			var me = this,
				recView = this.recView,
				model = recView.model,
				$inputRedirectLink = this.elems.$inputRedirectLink,
				$redirectLinkBtn = this.elems.$redirectLinkBtn,
				fileManager = window.Editor.Views.Modals.fileManager;

				$inputRedirectLink
				.hide();

				$redirectLinkBtn.removeClass('actived');
			...
			fileManager.show({
				type: 4, //saber qual número é a representação de todos os tipos de arquivos
				callback: function(data) {
					me.handlerPickedFile(data, index);
				}
			});
		},

		handlerPickedFile: function(data, index){
			console.log('foo [rec]file [method]handlerPickedFile: ', data);
			var me = this,
				recView = this.recView,
				model = recView.model,
				url = data.path,
