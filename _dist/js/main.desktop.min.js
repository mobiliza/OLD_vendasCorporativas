...
define('resources/multimedia/editor',[], function() {
...
define('../../../../../player/_base/js/scorm/initScorm',[], function() {
	...
	var initScorm = function() {
		var config = Player.Config.general.scorm,
			...
			jsonScorm = Player.json.courseScorm,
...
define('text!slides/templateAtividade/template.html',[],function () { return '<div style="{{style}}" id="{{_id}}" class="{{class}}">\t\n\t<div class="slideBackground {{^background.src}}noContent{{/background.src}}">\n\t\t<img src="{{#background.src}} {{background.src}} {{/background.src}}" height="100%" width="100%"/>\n\t\t<span class="glyphicon glyphicon-picture"></span>\n\t</div>\n</div>\n';});

define('slides/templateAtividade/player',[
	'jquery'
	], function($) {
...
define('text!slides/templateTexto/template.html',[],function () { return '<div style="{{style}}" id="{{_id}}" class="{{class}}">\t\n\t<div class="slideBackground {{^background.src}}noContent{{/background.src}}">\n\t\t<img src="{{#background.src}} {{background.src}} {{/background.src}}" height="100%" width="100%"/>\n\t\t<span class="glyphicon glyphicon-picture"></span>\n\t</div>\n</div>\n';});

define('slides/templateTexto/player',[
	'jquery'
	], function($) {
...
define('text!slides/templateAudio/template.html',[],function () { return '<div style="{{style}}" id="{{_id}}" class="{{class}}">\t\n\t<div class="slideBackground {{^background.src}}noContent{{/background.src}}">\n\t\t<img src="{{#background.src}} {{background.src}} {{/background.src}}" height="100%" width="100%"/>\n\t\t<span class="glyphicon glyphicon-picture"></span>\n\t</div>\n</div>\n';});

define('slides/templateAudio/player',[
	'jquery'
	], function($) {
...
define('text!../../../../_baseClient/_base/js/desktop/resources/botaoPP/template.html',[],function () { return '<div style="position: absolute; top: 0px;"> <!--Criado um elemento sem altura definida, para o botaoPP poder redimensionar verticalmente de acordo com o texto inserido no Editor.-->\n\t<div id="{{_id}}" class="{{class}} {{#type}}{{type}}{{/type}}" style="{{style}}">\n\t\t<div class="plus"></div>\n\t\t<div class="btnPPLeft">\t\n\t\t\t<div class="iconP3 iconP3-modal"></div>\n\t\t</div>\n\t\t<div class="btnPPRight"> \n\t\t\t<div class="tagP">{{&label}}</span>\n\t\t</div>\n\t</div>\n</div>';});
